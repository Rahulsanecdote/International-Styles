      ...
      <main className="min-h-screen bg-[#0A0A0A] pt-24">
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#F5F5F5] font-display text-lg max-w-2xl mx-auto">
            ...
            {stats && (
              <div className="flex flex-wrap items-center justify-center gap-8 mt-12 pb-12 border-b border-[#222222]">
                <div className="text-center">
                  ...
                  <p className="text-[#F5F5F5] font-display text-sm">Average Rating</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-[#F5F5F5] font-display text-sm mt-2">Total Reviews</p>
                </div>
                    ...
                    <div className="flex gap-6">
                      {stats.google > 0 && (
                        <div className="text-center">
                          ...
                          <p className="text-[#F5F5F5] font-display text-xs mt-1">Google</p>
                        </div>
                      )}
                      {stats.yelp > 0 && (
                        <div className="text-center">
                          <p className="font-display text-2xl text-[#C9A84C]">{stats.yelp}</p>
                          <p className="text-[#F5F5F5] font-display text-xs mt-1">Yelp</p>
                        </div>
                      )}
                      {stats.booksy > 0 && (
                        <div className="text-center">
                          <p className="font-display text-2xl text-[#C9A84C]">{stats.booksy}</p>
                          <p className="text-[#F5F5F5] font-display text-xs mt-1">Booksy</p>
                        </div>
                      )}
                    </div>
                  </>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-20 border border-[#222222] bg-[#111111]">
              <p className="text-[#F5F5F5] font-display text-lg">
                No reviews found with the selected filters.
              </p>
            </div>
          ) : (
            <>
              <p className="text-[#F5F5F5] font-display text-sm mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredReviews.map((review) => (
                  ...
                  >
                    ...
                    {/* Review Text */}
                    <p className="text-[#F5F5F5] font-display text-sm leading-relaxed mb-4">
                    ...
                    <div className="border-t border-[#222222] pt-4">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <p className="text-xs text-[#F5F5F5] uppercase tracking-wider font-display">
                        ...
                        <p className="text-xs text-[#F5F5F5] font-display">
